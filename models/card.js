...
exports.getReviewCards = userId => new Promise((resolve, reject) => {
...
exports.addCards = (userId, newWords) => new Promise((resolve, reject) => {
  const words = newWords.map(word => [userId, word.id]);
...
exports.getCard = cardId => new Promise((resolve, reject) => {
  const sql = `SELECT * FROM cards
                WHERE id = ?`;
...
exports.updateCard = (updatedCard) => {
  const {
    easiness, consecutiveCorrectAnswers, nextDueDate, id,
  } = updatedCard;
